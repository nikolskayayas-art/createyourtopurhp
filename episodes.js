...
const data = {
  ru: [
    ...
    {num:6, date:"20/11", full:"Дата выхода: 20 ноября",
      links:[{text:"Смотреть в VK", url:"https://vk.com/video-215535783_456245696?list=1616be10445e499c1c"}],
      msgTitle:"Просмотр возможен только в VK",
      msgText:"Для просмотра этого эпизода нужно авторизоваться в VK"},
    {num:7, date:"27/11", full:"Дата выхода: 27 ноября",
      links:[{text:"Смотреть в VK", url:"https://vk.com/video-215535783_456245782?list=f777e86c82ab891e46"}],
      msgTitle:"Просмотр возможен только в VK",
      msgText:"Для просмотра этого эпизода нужно авторизоваться в VK"},
  ...
  en: [
    ...
    {num:6, date:"20/11", full:"Release date: November 20",
      links:[{text:"Watch on VK", url:"https://vk.com/video-215535783_456245696?list=1616be10445e499c1c"}],
      msgTitle:"Available only on VK",
      msgText:"You must be logged in to VK to watch this episode."},
    {num:7, date:"27/11", full:"Release date: November 27",
      links:[{text:"Watch on VK", url:"https://vk.com/video-215535783_456245782?list=f777e86c82ab891e46"}],
      msgTitle:"Available only on VK",
      msgText:"You must be logged in to VK to watch this episode."},
