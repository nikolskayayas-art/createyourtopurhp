const contestants = {
  korea: [
    {name:"CHOI GAYOON", country:"korea", image:"https://i.imgur.com/iXCOXZr.jpg"},
    {name:"CHOI YOUMIN", country:"korea", image:"https://i.imgur.com/1ZOrjwe.jpg"},
    {name:"HAN HEEYEON", country:"korea", image:"https://i.imgur.com/L4CEU6m.jpg"},
    ...
    {name:"KIM SUJIN", country:"korea", image:"https://i.imgur.com/QL2FKUS.jpg"},
    ...
    {name:"LEE CHAEYEON", country:"korea", image:"https://i.imgur.com/Z4jDB3h.jpg"},
    {name:"LEE JOOEUN", country:"korea", image:"https://i.imgur.com/Hv2UhiV.jpeg"},
    {name:"LEE SEOHYUN", country:"korea", image:"https://i.imgur.com/rZcjbAQ.jpg"},
    {name:"MIN JIHO", country:"korea", image:"https://i.imgur.com/FcvQMcR.jpg"},
    {name:"NAM YUJU", country:"korea", image:"https://i.imgur.com/2RRYhVr.jpg"},
    {name:"RYU HAJIN", country:"korea", image:"https://i.imgur.com/1KfZQGf.jpg"},
    {name:"SHIN YOOKYUNG", country:"korea", image:"https://i.imgur.com/UhMyjfd.jpg"},
    ...
    for(let i=0;i<perRow && slotIndex<currentFormat;i++){
      ...
      if(pyramidSlots[slotIndex]){
        ...
        slot.innerHTML = `
          ...
          <img src="${c.image}" crossorigin="anonymous" class="contestant-img ${c.country}-border">
          ${slotIndex===0 
